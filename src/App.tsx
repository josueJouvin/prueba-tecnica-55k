...
function App() {
  ...
  const sortUsers = useMemo(() => {
    ...
    if(sorting === SortBy.COUNTRY){
      return searchUsers.sort((a, b) => a.location.country.localeCompare(b.location.country))
    }

    if(sorting === SortBy.NAME){
      return searchUsers.sort((a, b) => a.name.first.localeCompare(b.name.first))
    }
  ...
  return (
    <>
      ...
      <div className="filters">
        ...
        <button onClick={toggleOrderCountry}>{sorting === SortBy.COUNTRY ? "No ordenar por pais" : "Ordenar por pais"}</button>
